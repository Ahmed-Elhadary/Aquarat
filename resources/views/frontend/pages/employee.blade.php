                    ...
                    <div class="container">
                        <div class="site-filters clearfix center  m-b40">
                            <ul class="filters" data-toggle="buttons">
                                ...
                                <li data-filter="{{ $position->ar_title }}" class="btn">
                                    <input type="radio">
                                    <a href="javascript:void(0);" class="site-button-secondry button-sm radius-xl">
                                        <span> {{ $position->ar_title }} </span></a>
                                 </li>
                                @endforeach
                        ...
                        <div class="clearfix" id="lightgallery">
                            <ul id="masonry" class="portfolio-ic dlab-gallery-listing gallery-grid-4 lightgallery text-center" style="position: relative; height: 3568.87px;">
                              ...
                              <li class="{{ $person->position->ar_title }} design card-container col-lg-3 col-md-4 col-sm-6 p-a0 p-1" style="position: absolute; left: 0px; top: 0px;">
